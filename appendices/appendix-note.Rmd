...
\end{align*}
as $N \rightarrow \infty$ by the definition of an unstable FSFS model (c.f. Definition \@ref(def:instabFSFS)). Consequently, $P_{\boldsymbol \theta_N}(M_{\epsilon, \boldsymbol \theta_N}) \rightarrow 1$ as $N \rightarrow \infty$ as claimed. \hfill $\Box$
