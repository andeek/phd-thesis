...
$endif$
$if(mprofs)$
\mprofs$for(mprofs)${$mprofs$}$endfor$
$endif$
$if(member)$
...
% redefine hypertarget command to add a line break after the target
% needed to avoid overfull vbox (which leads to incorrect page breaking)
