...
This is a generalization of "unstable" used in @schweinberger2011instability by allowing 
...
If the scaled ELPR is large, then the FSFS model will exhibit large changes in probability for very small differences in the data configuration
...
In S-unstable FSFS models, all probability in the model formulation with a large number of random variables will concentrate mass on mode sets of arbitrarily small size
